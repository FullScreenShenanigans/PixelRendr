...
mochaLoader.addTest("returns palettes as Uint8ClampedArray with a zero color at the front", (): void => {
    ...
    // Act
    let palette = PixelRender.generatePaletteFromRawData(new PixelRender.Uint8ClampedArray([0, 9, 0, 8]), true);
...
mochaLoader.addTest("returns palettes as Uint8ClampedArray if forceZeroColor is false", (): void => {
    ...
    // Act
    let palette = PixelRender.generatePaletteFromRawData(new PixelRender.Uint8ClampedArray([0, 9, 0, 8]));
...
mochaLoader.addTest("returns palettes as arrays if forceZeroColor is false", (): void => {
    ...
    // Act
    let palette = PixelRender.generatePaletteFromRawData(new PixelRender.Uint8ClampedArray([0, 9, 0, 8]), undefined, true);
...
mochaLoader.addTest("returns palettes as arrays if forceZeroColor is true", (): void => {
    ...
    // Act
    let palette = PixelRender.generatePaletteFromRawData(new PixelRender.Uint8ClampedArray([0, 9, 0, 8]), true, true);
